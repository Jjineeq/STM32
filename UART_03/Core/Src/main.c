...
#define TxBufferSize_6   (countof(TxBuffer_6)-1)
#define TxBufferSize_7   (countof(TxBuffer_7)-1)
#define TxBufferSize_8   (countof(TxBuffer_8)-1)
#define TxBufferSize_9   (countof(TxBuffer_9)-1)
